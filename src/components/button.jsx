...
export function Button({text, image, color, link}) {
  return (
     <Link to={link}>
          ...
          className="flex flex-col w-110 sm:w-140 shadow-2xl hover:opacity-98 cursor-pointer text-2xl font-bold p-7 rounded-lg gap-3 transition duration-300 ease-in-out transform hover:scale-101 hover:-translate-y-2">
